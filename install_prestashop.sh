...
apt install -y net-tools apache2 mariadb-server php7.3 php7.3-gd php7.3-mbstring php7.3-mysql php7.3-curl php-xml php7.3-intl php7.3-zip php-simplexml php-zip php-zip php-curl php-gd php-mysql-y php-intl
